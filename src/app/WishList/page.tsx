    ...
    <>
      <div className='mx-auto w-full md:w-[80%] bg-gray-100 my-10 p-5 '>
        ...
        {s.map(function (products: Wishproduct, idx: number) {
          return <div key={idx} className='py-5 justify-between border-b-2 border-gray-400 my-5 flex w-full md:[80%] items-center'>
            <div className='flex items-center gap-5'>
              ...
              <div>
                ...
                <div className='flex items-center flex-col md:flex-row gap-5 my-3'>
                  <Button onClick={() => {
                    delet(products._id)
                  }}
